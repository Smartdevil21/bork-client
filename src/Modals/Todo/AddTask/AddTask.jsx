...
function AddTask({ setOpenaddModal }) {
	...
	useEffect(()=>{
		setTask((prev)=>({...prev,deadline:`${yyyy}-${mm}-${dd}`,createdOn:`${yyyy}-${mm}-${dd}`}));
	},[]);
		...
		<div className={Styles.task_details}>
			...
			<div className={Styles.edit_task_inputs_wrapper}>
				<Stack direction={"column"} spacing={2}>
					<TextField variant="outlined" size="small" autoFocus value={task.title} onChange={(e)=>{
